...
|---|---|---|
| **Image-Based Plant Disease Detection System** | An AI-powered image classification system that analyzes plant leaf images to identify whether a plant is healthy or affected by disease. | Python, TensorFlow, Keras, CNN, Google Colab |
| **Esports Championship Management System** | A database-driven management system designed to efficiently manage esports teams, tournaments, registrations, matches, users, and leaderboards. | Python, MongoDB, HTML, CSS, JavaScript |
